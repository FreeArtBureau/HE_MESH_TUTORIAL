...
void controlInit() {
  ...
  Toggle t2 = INTERFACES.addToggle("EXTRUDE").setPosition(80, 140).setSize(15, 15).setValue(false).setLabel("Extrude On/Off");
  ...
  Slider extrudeDist = INTERFACES.addSlider("EXTRUDEDIST").setPosition(10, 220).setRange(1, 80).setValue(10); 

  Bang b1 = INTERFACES.addBang("bang").setPosition(10, 240).setSize(15, 15).setTriggerEvent(Bang.RELEASE).setLabel("REMAKE MESH");
}
